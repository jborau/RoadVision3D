...
from roadvision3d.src.models.backbones.resnet import resnet50
from roadvision3d.src.models.backbones.dla import dla34
from roadvision3d.src.models.backbones.dlaup import DLAUp
from roadvision3d.src.models.backbones.dlaup import DLAUpv2
...
class SMOKE(nn.Module):
    def __init__(self, backbone='dla34', neck='DLAUp', loss='XXXX', downsample=4, mean_size=None):
        assert downsample in [4, 8, 16, 32]
        super().__init__()

        classes = mean_size.shape[0]
        regression = 8 # cfg.MODEL.SMOKE_HEAD.REGRESSION_HEADS
        # TODO: see what is this
        regression_channels = 8 #cfg.MODEL.SMOKE_HEAD.REGRESSION_CHANNEL
        head_conv = 256 # cfg.MODEL.SMOKE_HEAD.NUM_CHANNEL
        norm_func = _HEAD_NORM_SPECS['GN'] # _HEAD_NORM_SPECS[cfg.MODEL.SMOKE_HEAD.USE_NORMALIZATION]
        ...
        in_channels = self.backbone.channels  # channels list for feature maps generated by backbone
        ...
        self.fill_fc_weights(self.regression_head)
    ...
    def get_losses(self, inputs, coord_ranges, calibs, targets, epoch):
        criterion = self.loss(epoch)
        outputs = self.forward(inputs,coord_ranges,calibs,targets)

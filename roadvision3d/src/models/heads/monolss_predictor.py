...
class MonoLSSPredictor(nn.Module):
    def __init__(self, cfg, channels, first_level):
        super(MonoLSSPredictor, self).__init__()
...
def build_monolss_predictor(cfg, in_channels, first_level):
    return MonoLSSPredictor(cfg, in_channels, first_level)